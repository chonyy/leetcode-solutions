<h2><a href="https://leetcode.com/problems/design-excel-sum-formula">631. Design Excel Sum Formula</a></h2><h3>Hard</h3><hr><p>Design the basic function of <strong>Excel</strong> and implement the function of the sum formula.</p>
