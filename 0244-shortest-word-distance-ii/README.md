<h2><a href="https://leetcode.com/problems/shortest-word-distance-ii">244. Shortest Word Distance II</a></h2><h3>Medium</h3><hr><p>Design a data structure that will be initialized with a string array, and then it should answer queries of the shortest distance between two different strings from the array.</p>
