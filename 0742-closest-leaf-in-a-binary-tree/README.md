<h2><a href="https://leetcode.com/problems/closest-leaf-in-a-binary-tree">743. Closest Leaf in a Binary Tree</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree where every node has <strong>a unique value</strong> and a target integer <code>k</code>, return <em>the value of the <strong>nearest leaf node</strong> to the target </em><code>k</code><em> in the tree</em>.</p>
